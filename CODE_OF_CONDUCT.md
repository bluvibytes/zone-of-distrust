...
Zones of Distrust (ZoD) is a security-focused open project. We aim to build a constructive, adversarial-friendly community where ideas, implementations, and claims can be challenged rigorously without hostility.

This Code of Conduct applies to all project spaces, including GitHub issues, pull requests, discussions, and any community channels associated with the project.
...
- Attack ideas and implementations, not people.
...
Enforcement decisions are made at the maintainers’ discretion to protect the safety, integrity, and long-term health of the community.

---

## Scope

This Code of Conduct applies to all official ZoD project spaces and interactions where the project is represented.

---

## Attribution

This Code of Conduct is inspired by common open-source best practices and adapted specifically for adversarial security research collaboration.
